...
export function WhatsAppBubble() {
  return (
    ...
    >
      ...
      <span className="flex size-14 items-center justify-center rounded-full bg-whatsapp text-paper shadow-soft transition-transform duration-150 group-hover:scale-105 group-active:scale-95">
